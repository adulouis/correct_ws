...
class AStarPlannerPlanner(Node):
    def __init__(self):
    ...
    def goalCallback(self, pose: PoseStamped):
        ...
        path = self.AStarPlannerPath(map_to_robot_pose, pose.pose)
    ...
    def AStarPlannerPath(self, start: Pose, end: Pose):
        ...
        goal_node = self.world_to_grid(end)
    ...
    def manhattan_distance(self, node: GraphNode, goal_node: GraphNode)->GraphNode:
