...
PID right_motor(&right_wheel_meas_vel, &right_wheel_cmd, &right_wheel_cmd_vel, kp_r, ki_r, kd_r, DIRECT);
PID left_motor(&left_wheel_meas_vel, &left_wheel_cmd, &left_wheel_cmd_vel, kp_l, ki_l, kd_l, DIRECT);
...
void loop() {
  ...
  if(Serial.available())
  {
    ...
    else if(chr == 'p') //to rotate clockwise
    {
