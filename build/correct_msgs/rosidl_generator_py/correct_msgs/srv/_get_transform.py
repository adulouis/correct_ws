...
class Metaclass_GetTransform(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from correct_msgs.srv import _get_transform
...
class GetTransform(metaclass=Metaclass_GetTransform):
    from correct_msgs.srv._get_transform import GetTransform_Request as Request
    from correct_msgs.srv._get_transform import GetTransform_Response as Response
