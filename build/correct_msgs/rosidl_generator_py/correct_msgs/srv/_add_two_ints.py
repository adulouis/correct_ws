...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from correct_msgs.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from correct_msgs.srv._add_two_ints import AddTwoInts_Request as Request
    from correct_msgs.srv._add_two_ints import AddTwoInts_Response as Response
